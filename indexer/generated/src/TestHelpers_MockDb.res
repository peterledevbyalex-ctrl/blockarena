...
@genType
and entities = {
    @as("Arena") arena: entityStoreOperations<Entities.Arena.t>,
    @as("ArenaEntry") arenaEntry: entityStoreOperations<Entities.ArenaEntry.t>,
    @as("EmergencyEvent") emergencyEvent: entityStoreOperations<Entities.EmergencyEvent.t>,
    @as("Player") player: entityStoreOperations<Entities.Player.t>,
    @as("ProtocolStats") protocolStats: entityStoreOperations<Entities.ProtocolStats.t>,
    @as("ReferralPayment") referralPayment: entityStoreOperations<Entities.ReferralPayment.t>,
    @as("Tournament") tournament: entityStoreOperations<Entities.Tournament.t>,
    @as("TournamentArena") tournamentArena: entityStoreOperations<Entities.TournamentArena.t>,
    @as("TournamentQualification") tournamentQualification: entityStoreOperations<Entities.TournamentQualification.t>,
    @as("TreasuryWithdrawal") treasuryWithdrawal: entityStoreOperations<Entities.TreasuryWithdrawal.t>,
  }
  ...
  let entities = {
      arena: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Arena)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Arena.t,
            >
      ...
      arenaEntry: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ArenaEntry)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ArenaEntry.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      emergencyEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.EmergencyEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.EmergencyEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      protocolStats: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ProtocolStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ProtocolStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      referralPayment: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ReferralPayment)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ReferralPayment.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      tournament: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Tournament)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Tournament.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      tournamentArena: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TournamentArena)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TournamentArena.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      tournamentQualification: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TournamentQualification)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TournamentQualification.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      treasuryWithdrawal: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TreasuryWithdrawal)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TreasuryWithdrawal.t,
            >
          ),
          ~getKey=({id}) => id,
        )
